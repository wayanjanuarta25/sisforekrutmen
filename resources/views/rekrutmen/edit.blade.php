...
<html lang="en">
<head>
    <title>Edit Rekrutmen | Sisfo Werving Satsiber TNI</title>
    <meta charset="utf-8">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h5 class="m-b-10">Edit Rekrutmen</h5> {{-- Judul halaman --}}
                            </div>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('rekrutmen-event.index') }}">Rekrutmen</a></li>
                                <li class="breadcrumb-item"><a href="javascript: void(0)">Edit Rekrutmen</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-8">
                    <div class="card">
                        <div class="card-header">
                            <h5>Form Edit Rekrutmen </h5>
                        </div>
                        {{-- Form untuk mengupdate data event rekrutmen --}}
                        <form method="POST" action="{{ route('rekrutmen-event.update', $rekrutmenEvent->id) }}">
                            @csrf
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('nama_rekrutmen') is-invalid @enderror"
                                           id="nama_rekrutmen" name="nama_rekrutmen"
                                           value="{{ old('nama_rekrutmen', $rekrutmenEvent->nama_rekrutmen) }}" {{-- Tampilkan data lama --}}
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control @error('tanggal_rekrutmen') is-invalid @enderror"
                                           id="tanggal_rekrutmen" name="tanggal_rekrutmen"
                                           value="{{ old('tanggal_rekrutmen', $rekrutmenEvent->tanggal_rekrutmen) }}" {{-- Tampilkan data lama --}}
                                           required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('lokasi_rekrutmen') is-invalid @enderror"
                                           id="lokasi_rekrutmen" name="lokasi_rekrutmen"
                                           value="{{ old('lokasi_rekrutmen', $rekrutmenEvent->lokasi_rekrutmen) }}" {{-- Tampilkan data lama --}}
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('status') is-invalid @enderror" id="status" name="status" required>
                                        <option value="berjalan" {{ old('status', $rekrutmenEvent->status) == 'berjalan' ? 'selected' : '' }}>Berjalan</option>
                                        <option value="selesai" {{ old('status', $rekrutmenEvent->status) == 'selesai' ? 'selected' : '' }}>Selesai</option>
                                    </select>
                                    @error('status')
                                        <div class="text-danger mt-1">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="card-footer">
                                ...
                                <a href="{{ route('rekrutmen-event.index') }}" class="btn btn-light">Batal</a>
                            </div>
                        </form>
                    </div>
                </div>
